 ...
 * <ul>
 *   <li><b>Эффективный overlap</b> — наивный поиск конфликтов O(n²); interval-tree / сортировка-по-началу → O(n log n).</li>
 *   <li><b>Разворот recurrence с ГОРИЗОНТОМ</b> (бесконечная периодичность — докуда генерить для conflict/slot); DST/таймзоны для DAILY; thread-safety add/remove.</li>
 * </ul>
 */
