 ...
 * <ul>
 *   <li><b>Thread-safety + порядок сообщений:</b> конкурентный sendMessage в один чат → корректный монотонный порядок (seq/timestamp); edit/delete гонка (только автор, атомарно); unread-count консистентен.</li>
 *   <li>Стабильная пагинация под конкурентной вставкой (курсор по seq, не offset); мягко-удалённые не в выборках, но занимают место (индекс активных).</li>
 * </ul>
 */
