 ...
 * <ul>
 *   <li><b>Thread-safety графа:</b> конкурентные addModule/removeModule → гонка на рёбрах; консистентный snapshot для resolve.</li>
 *   <li>Topological sort (Kahn/DFS) + cycle-detect (has); getDependents = обратный индекс (не скан); <b>итеративный DFS</b> для глубоких графов (против stack overflow).</li>
 * </ul>
 */
