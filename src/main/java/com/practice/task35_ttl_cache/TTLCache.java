 ...
 * <ul>
 *   <li><b>⭐ Thread-safety</b> — гонка get(lazy-expire) + cleanup + put; атомарная проверка-истечения-и-удаления.</li>
 *   <li><b>Фоновая active-eviction</b> через ScheduledExecutor + <b>её graceful shutdown</b> (связка с applied-concurrency); TTL+capacity (bounded LRU+TTL); size() при lazy-expire = O(n)/неточен под конкуррентой.</li>
 * </ul>
 */
