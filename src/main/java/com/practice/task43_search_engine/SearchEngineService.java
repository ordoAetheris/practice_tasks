 ...
 * <ul>
 *   <li><b>Thread-safety индекса:</b> конкурентные addDocument/removeDocument → гонка постинг-листов; атомарное обновление инвертированного индекса.</li>
 *   <li>Эффективный AND = пересечение постингов (от короткого к длинному, не декартово); TF-ранжирование через heap topK; edge (пустой запрос, стоп-слова).</li>
 * </ul>
 */
