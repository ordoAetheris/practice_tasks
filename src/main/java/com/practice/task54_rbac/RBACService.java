 ...
 * <ul>
 *   <li><b>Thread-safety:</b> конкурентное изменение ролей/наследования vs hasPermission (снапшот/лок); кэш разрешений + инвалидация при смене роли.</li>
 *   <li>Эффективный обход иерархии (мемоизация цепочки, не пересчёт каждый раз); cycle-detection при setRoleParent (has); ADMIN-раскрытие в READ/WRITE/DELETE.</li>
 * </ul>
 */
