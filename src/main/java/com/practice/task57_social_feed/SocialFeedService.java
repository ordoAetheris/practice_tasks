 ...
 * <ul>
 *   <li><b>Fan-out on write vs on read</b> (селеба с 10M подписчиков — гибрид); thread-safety постов/подписок/лайков; <b>like-once под конкуррентой</b> (putIfAbsent на (user,post), likesCount atomic).</li>
 *   <li>Генерация ленты = merge отсортированных постов подписок (heap, не сорт всего); курсорная пагинация; getMutualFollowers = пересечение множеств.</li>
 * </ul>
 */
