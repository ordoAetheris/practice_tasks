 ...
 * <ul>
 *   <li><b>Thread-safety Trie:</b> конкурентные addWord/removeWord → гонка на узлах (атомарное поддерево / лок).</li>
 *   <li>Эффективный topK по префиксу (heap на обходе поддерева / кэш top-K в узле); edge (пустой префикс = все → ограничить/остерегаться взрыва), большой алфавит (Map vs массив).</li>
 * </ul>
 */
