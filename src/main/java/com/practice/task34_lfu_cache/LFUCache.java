 ...
 * <ul>
 *   <li><b>⭐ Thread-safe LFU</b> — атомарное обновление (частота + freq-bucket + minFrequency) под конкуррентой сложнее LRU. Наивный единый лок = bottleneck.</li>
 *   <li>Корректность minFrequency при eviction/remove (edge: опустошение бакета минимума).</li>
 * </ul>
 */
