 ...
 * <ul>
 *   <li><b>⭐ Конкурентный record</b> (частые записи из многих потоков) → thread-safety без bottleneck (per-metric лок / striping / concurrent structure); эффективное окно (ring buffer / expire старых, не хранить всё).</li>
 *   <li>Percentile (t-digest / отсортированный срез окна); edge (пустое окно → NoSuchElementException); дрейф часов.</li>
 * </ul>
 */
